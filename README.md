...
│       ├── api/                # FastAPI routers
│       │   ├── __init__.py
│       │   └── router.py       # /discover, /variants, /bottlenecks endpoints
...
└── tests/
    ...
    └── interview_prep/
        ...
        └── test_api.py         # 33 tests, 100% coverage on router + main
```
...
| `/api/v1/insights` | AI-generated summary of process bottlenecks |
